...
There are [several possibilities to generate COinS](https://en.wikipedia.org/wiki/COinS#Client_tools). In a blog entry, I have focused on producing COinS with [Zotero](https://zotero.org). I am not going into further details here, but [I have prepared a tutorial](https://notes.peter-baumgartner.net/2019-06-19-how-to-produce-coins.md") with images from all the necessary steps to produce, embed, and download [COinS](https://www.questia.com/magazine/1G1-161981672/coins-what-it-stands-for-context-objects-in-spans). But this is a quite complicated procedure with several steps. Besides, it works only for every page individually and not automatically for all blog entries of your website.
...
> No 'author' found in yaml frontmatter, config.toml and in options (blogdown.author) in '.Rrofile.
